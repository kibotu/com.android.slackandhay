...
public class GLBufferLibrary {
	...
	// holds all floatbuffers
	private final Vector<FloatBuffer> _textureFloatBuffers;

	// holds all floats for until it is allocated
	private final List<Float> _floatList;

	// holds the textures dimensions and ids
	...
	private void addGUICoords() {
		...
		addTextureCoord(959f / c, 133f / c, 60f / c, 70f / c); // sword
		addTextureCoord(961f / c, 63f / c, 59f / c, 63f / c); // shield
		addTextureCoord(957f / c, 0f / c, 66f / c, 61f / c); // legs
	}
	...
	/**
	 * adds posibility to repeat textures
	 */
	...
	private void addCronoTextureCoords() {
		...
		// mirrored
		addTextureCoordMirroredOnYAxe(77f / c, 182f / c, 15f / c, 34f / c); // 171
																			// (63)
																			// done
		addTextureCoordMirroredOnYAxe(101f / c, 184f / c, 21f / c, 32f / c); // 172
																				// (64)
																				// done
		addTextureCoordMirroredOnYAxe(127f / c, 183f / c, 15f / c, 33f / c); // 173
																				// (65)
																				// done
		addTextureCoordMirroredOnYAxe(150f / c, 182f / c, 14f / c, 34f / c); // 174
																				// (66)
																				// done
		addTextureCoordMirroredOnYAxe(172f / c, 184f / c, 22f / c, 32f / c); // 175
																				// (67)
																				// done
		addTextureCoordMirroredOnYAxe(201f / c, 183f / c, 14f / c, 33f / c); // 176
																				// (68)
																				// done
		addTextureCoordMirroredOnYAxe(9f / c, 52f / c, 16f / c, 55f / c); // 177
																			// (22)
																			// done
		addTextureCoordMirroredOnYAxe(116f / c, 52f / c, 35f / c, 55f / c); // 178
																			// (26)
																			// done
		addTextureCoordMirroredOnYAxe(433f / c, 52f / c, 28f / c, 55f / c); // 179
																			// (36)
																			// done
		addTextureCoordMirroredOnYAxe(150f / c, 506f / c, 18f / c, 55f / c); // 180
																				// (162)
																				// done
		addTextureCoordMirroredOnYAxe(32f / c, 52f / c, 19f / c, 55f / c); // 181
																			// (23)
																			// done
		addTextureCoordMirroredOnYAxe(58f / c, 52f / c, 19f / c, 55f / c); // 182
																			// (24)
																			// done
		addTextureCoordMirroredOnYAxe(85f / c, 52f / c, 27f / c, 55f / c); // 183
																			// (25)
																			// done
		addTextureCoordMirroredOnYAxe(14f / c, 228f / c, 16f / c, 50f / c); // 184
																			// (78)
																			// done
		addTextureCoordMirroredOnYAxe(484f / c, 223f / c, 31f / c, 50f / c); // 185
																				// (92)
																				// done
		addTextureCoordMirroredOnYAxe(482f / c, 170f / c, 32f / c, 50f / c); // 186
																				// (76)
																				// done
		addTextureCoordMirroredOnYAxe(519f / c, 170f / c, 32f / c, 50f / c); // 187
																				// (77)
																				// done
		addTextureCoordMirroredOnYAxe(40f / c, 228f / c, 31f / c, 50f / c); // 188
																			// (79)
																			// done
		addTextureCoordMirroredOnYAxe(78f / c, 228f / c, 29f / c, 50f / c); // 189
																			// (80)
																			// done
		addTextureCoordMirroredOnYAxe(325f / c, 167f / c, 29f / c, 50f / c); // 190
																				// (72)
																				// done
		addTextureCoordMirroredOnYAxe(155f / c, 228f / c, 22f / c, 50f / c); // 191
																				// (82)
																				// done
		addTextureCoordMirroredOnYAxe(247f / c, 335f / c, 22f / c, 44f / c); // 192
																				// (120)
																				// done
		addTextureCoordMirroredOnYAxe(40f / c, 393f / c, 16f / c, 48f / c); // 193
																			// (129)
																			// done
		addTextureCoordMirroredOnYAxe(12f / c, 393f / c, 17f / c, 48f / c); // 194
																			// (128)
																			// done
		addTextureCoordMirroredOnYAxe(166f / c, 458f / c, 16f / c, 48f / c); // 195
																				// (151)
																				// done
		addTextureCoordMirroredOnYAxe(147f / c, 393f / c, 32f / c, 48f / c); // 196
																				// (133)
																				// done
		addTextureCoordMirroredOnYAxe(63f / c, 393f / c, 20f / c, 48f / c); // 197
																			// (130)
																			// done
		addTextureCoordMirroredOnYAxe(89f / c, 393f / c, 17f / c, 48f / c); // 198
																			// (131)
																			// done
		addTextureCoordMirroredOnYAxe(113f / c, 393f / c, 27f / c, 48f / c); // 199
																				// (132)
																				// done
		addTextureCoordMirroredOnYAxe(77f / c, 182f / c, 15f / c, 34f / c); // 200
																			// (63)
																			// done
		addTextureCoordMirroredOnYAxe(101f / c, 184f / c, 21f / c, 32f / c); // 201
																				// (64)
																				// done
		addTextureCoordMirroredOnYAxe(369f / c, 187f / c, 28f / c, 32f / c); // 202
																				// (73)
																				// done
		addTextureCoordMirroredOnYAxe(401f / c, 187f / c, 28f / c, 32f / c); // 203
																				// (74)
																				// done
		addTextureCoordMirroredOnYAxe(172f / c, 184f / c, 22f / c, 32f / c); // 204
																				// (67)
																				// done
		addTextureCoordMirroredOnYAxe(201f / c, 183f / c, 14f / c, 33f / c); // 205
																				// (68)
																				// done
		addTextureCoordMirroredOnYAxe(440f / c, 206f / c, 32f / c, 14f / c); // 206
																				// (75)
																				// done
		addTextureCoordMirroredOnYAxe(167f / c, 68f / c, 18f / c, 32f / c); // 207
																			// (27)
																			// done
		addTextureCoordMirroredOnYAxe(188f / c, 408f / c, 22f / c, 32f / c); // 208
																				// (134)
																				// done
		addTextureCoordMirroredOnYAxe(192f / c, 247f / c, 20f / c, 30f / c); // 209
																				// (83)
																				// done
		addTextureCoordMirroredOnYAxe(11f / c, 181f / c, 14f / c, 34f / c); // 210
																			// (60)
																			// done
		addTextureCoordMirroredOnYAxe(30f / c, 181f / c, 14f / c, 34f / c); // 211
																			// (61)
																			// done
		addTextureCoordMirroredOnYAxe(49f / c, 181f / c, 14f / c, 34f / c); // 212
																			// (62)
																			// done
		addTextureCoordMirroredOnYAxe(13f / c, 294f / c, 14f / c, 34f / c); // 213
																			// (93)
																			// done
		addTextureCoordMirroredOnYAxe(402f / c, 241f / c, 14f / c, 32f / c); // 214
																				// (89)
																				// done
		addTextureCoordMirroredOnYAxe(455f / c, 239f / c, 14f / c, 34f / c); // 215
																				// (90)
																				// done
		addTextureCoordMirroredOnYAxe(436f / c, 239f / c, 14f / c, 34f / c); // 216
																				// (91)
																				// done
		addTextureCoordMirroredOnYAxe(325f / c, 186f / c, 29f / c, 31f / c); // 217
																				// (72)
																				// done
		addTextureCoordMirroredOnYAxe(342f / c, 293f / c, 29f / c, 30f / c); // 218
																				// (102)
																				// done
		addTextureCoordMirroredOnYAxe(325f / c, 186f / c, 29f / c, 31f / c); // 219
																				// (103)
																				// done
		addTextureCoordMirroredOnYAxe(226f / c, 348f / c, 16f / c, 31f / c); // 220
																				// (119)
																				// done
		addTextureCoordMirroredOnYAxe(247f / c, 348f / c, 22f / c, 31f / c); // 221
																				// (120)
																				// done
		addTextureCoordMirroredOnYAxe(470f / c, 409f / c, 24f / c, 32f / c); // 222
																				// (144)
																				// done
		addTextureCoordMirroredOnYAxe(306f / c, 11f / c, 17f / c, 32f / c); // 223
																			// (13)
																			// done
		addTextureCoordMirroredOnYAxe(390f / c, 12f / c, 17f / c, 31f / c); // 224
																			// (16)
																			// done
		addTextureCoordMirroredOnYAxe(412f / c, 12f / c, 18f / c, 31f / c); // 225
																			// (17)
																			// done
	}
	 ...
	 * @param height
	 */
	private void addTextureCoord(final float x, final float y,
			final float width, final float height) {
		glTexture.add(new GLTexture(width, height, _floatList.size()));
		_floatList.add(x + width);
		_floatList.add(y); // oben rechts
		_floatList.add(x);
		_floatList.add(y); // oben links
		_floatList.add(x);
		_floatList.add(y + height); // unten links
		_floatList.add(x + width);
		_floatList.add(y + height); // unten rechts
	}

	/**
	 * adds single image mirrored on y axe
	 * 
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	 */
	private void addTextureCoordMirroredOnYAxe(final float x, final float y,
			final float width, final float height) {
		glTexture.add(new GLTexture(width, height, _floatList.size()));
		_floatList.add(x);
		_floatList.add(y); // oben links
	...
	/**
	 * adds single image mirrored on x axe
	 * 
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	 */
	private void addTextureCoordMirroredOnXAxe(final float x, final float y,
			final float width, final float height) {
		glTexture.add(new GLTexture(width, height, _floatList.size()));
		_floatList.add(x);
		_floatList.add(y + height); // unten links
	...
	/**
	 * adds a texture coordinates to the gpu saves texture vbo id
	 * 
	 * @param coords
	 * @return textureVBOid
	 */
	...
	public Vector<Integer> bindTextureVBOids(final GL10 gl) {
		...
		// texture vbo id
		final IntBuffer _buffer = IntBuffer.allocate(_textureFloatBuffers
				.size());
		...
		for (int i = 0; i < textureFloatBuffersSize; i++) {
			...
			// Log.i(TAG, "bound: " +_textureFloatBuffers.get(i).toString() +
			// " to tvbo id "+textureVBOId);

			// binding for later re-use
			gl11.glBindBuffer(GL11.GL_ARRAY_BUFFER, textureVBOId);
			gl11.glBufferData(GL11.GL_ARRAY_BUFFER, _textureFloatBuffers.get(i)
					.capacity() * 4, _textureFloatBuffers.get(i),
					GL11.GL_STATIC_DRAW);
