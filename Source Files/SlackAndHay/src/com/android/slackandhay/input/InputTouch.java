...
/**
 * this class handles all the input from the touch screen
 * 
...
public class InputTouch {
	...
	// private final BUTTON_ACTIONS lastPushedButton = BUTTON_ACTIONS.NONE; TODO
	// benutz mich :)
	...
	/**
	 * the constructor defines what regions of the screen are used as buttons or
	 * as coordinate-maps. Right now this is hard coded, but should be dynamic
	 * in the future
	 */
	public InputTouch() {
		// defaults....
	...
	/**
	 * This Method determines what amount of the left side of the screen is
	 * counted as "map input", where 0f equals 0% and 1f equals 100%
	 * respectively.
	 * 
	 * @param ratio
	 */
	...
	/**
	 * this method sets the screen resolution of the touchscreen it is needed
	 * because all the touch inputs are mapped to pixels on the screen, so the
	 * touch screen input is depending on knowing the current resolution
	 * 
	...
	/**
	 * this method handles all the input touch events
	 * 
	 * @param event
	 *            the touch event that triggered this method call
	 * @return always true, because it handles everything all the time.
	 */
	...
	/**
	 * This method checks whether a button was pressed since the last time it
	 * was checked.
	 * 
	 * @param number
	 *            represents the Nth button.
