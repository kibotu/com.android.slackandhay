...
public abstract class GOGameObject {
	 ...
	 * 
	 * @param type	The {@link com.android.slackandhay.gameobject.component.GOComponent.ComponentType ComponentType}
	...
	public String toString() {
		return "GOGameObject [UID=" + UID + ", components="
				+ Arrays.toString(components) + ", stateManager="
				+ stateManager + "]";
	}
