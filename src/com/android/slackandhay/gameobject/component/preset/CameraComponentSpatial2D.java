...
public class CameraComponentSpatial2D  extends GOComponentSpatial2D {

	private static final String TAG = CameraComponentSpatial2D.class.getSimpleName();

	public CameraComponentSpatial2D(final GOGameObject parent, final GridWorld grid) {
		super(parent, grid);
	}
