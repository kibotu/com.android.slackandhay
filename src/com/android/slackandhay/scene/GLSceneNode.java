...
public abstract class GLSceneNode {
	 ...
	 * @param parent Der Elternknoten
	 */
	public GLSceneNode(GLSceneNode parent) {
		_parent = parent;
	}
	 ...
	 * @param parent Der Elternknoten
	 */
	public final void setParent(GLSceneNode parent) { _parent = parent; } 
	 ...
	 * @param z
	 */
	public GLSceneNode setPosition(float x, float y, float z) {
	 ...
	 * @param depth
	 */
	public GLSceneNode setDimension(float width, float height, float depth) {
	 ...
	 * @param b
	 */
	public GLSceneNode setColor(float r, float g, float b) {
		_ambientR = r;
		_ambientG = g;
		_ambientB = b;
		return this;
	 ...
	 */
	public void add(GLSceneNode child) {
		if (_childNodes == null) _childNodes = new ArrayList<GLSceneNode>();
	 ...
	 */
	public boolean remove(GLSceneNode child) {
	...
	public GLSceneNode getChild(int index) {
	...
	public void render(GL10 gl) {
		...
		// Object skalieren
		gl.glScalef(_width, _height, _depth);
	...
	/**
	 * Setzt nächstes Frame (Texture Vertex Buffer Index) 
	 * @param dt
	 */
	protected abstract void nextFrame(long dt);
}
